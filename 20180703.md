...
- Python 실습 : Google Colaboratory (https://colab.research.google.com/notebooks/welcome.ipynb#recent=true)
- Python 실습 2 : Pythontutor. 소스 코드를 단계별로 실행하면서 작동 원리/오류 원인을 확인 가능. (http://www.pythontutor.com)
